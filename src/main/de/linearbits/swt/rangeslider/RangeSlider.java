package de.linearbits.swt.rangeslider;
...
public class RangeSlider extends Canvas {
	...
	public RangeSlider(final Composite parent, final int style) {
		...
		this.slider = new Image(getDisplay(), this.getClass().getResourceAsStream("slider-normal.png"));
		this.sliderHover = new Image(getDisplay(), this.getClass().getResourceAsStream("slider-hover.png"));
		this.sliderDrag = new Image(getDisplay(), this.getClass().getResourceAsStream("slider-drag.png"));
		this.sliderSelected = new Image(getDisplay(), this.getClass().getResourceAsStream("slider-selected.png"));
		this.vSlider = new Image(getDisplay(), this.getClass().getResourceAsStream("h-slider-normal.png"));
		this.vSliderHover = new Image(getDisplay(), this.getClass().getResourceAsStream("h-slider-hover.png"));
		this.vSliderDrag = new Image(getDisplay(), this.getClass().getResourceAsStream("h-slider-drag.png"));
		this.vSliderSelected = new Image(getDisplay(), this.getClass().getResourceAsStream("h-slider-selected.png"));
		...
		this.addListener(SWT.Dispose, new Listener() {
			...
			public void handleEvent(final Event event) {
				safeDispose(RangeSlider.this.slider);
				safeDispose(RangeSlider.this.sliderHover);
				safeDispose(RangeSlider.this.sliderDrag);
				safeDispose(RangeSlider.this.sliderSelected);
				safeDispose(RangeSlider.this.vSlider);
				safeDispose(RangeSlider.this.vSliderHover);
				safeDispose(RangeSlider.this.vSliderDrag);
				safeDispose(RangeSlider.this.vSliderSelected);
